...
- the recommended threshold for triggering a rebuilding plan
...
* recommendation for what would trigger a rebuilding plan: how many year(s) of what metric (individual years vs running average vs ...) being below LRP would trigger a rebuilding plan, and rationale for recommendation 
