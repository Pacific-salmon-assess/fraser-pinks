...
ggplot(hcr, aes(x=run_size, y=er)) + 
  ...
  annotate("text", x = run_usr +1, y = 1.02, label = expression(paste("80%",S)[MSY]), color = "grey", size=3) +
...
```{r kobe-plot, out.height='80%', out.width = '80%', fig.cap= "Kobe plot of estimated spawner abundance and exploitation rate relative to S~MSY~ (x-axis) and U~MSY~ (y-axis) over time "}
...
```{r harvest Umsy, out.width = "75%", fig.cap = "Estimated exploitation rate over time (+/- 50% and 95% credible intervals) relative to the exploitation rate expected to maximize harvest over under equlibrium conditions (U~MSY~)"}
...
```{r recruitment residuals, out.width = "75%", fig.cap = "Recruitment resisduals over time +/- 50% and 95% credible intervals"}
