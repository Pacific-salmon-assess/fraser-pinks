...
```{r coarse kobe, out.height='80%', out.width = '80%', fig.cap= "Inferred Fraser pink salmon harvest control rule with estimated Limited Reference Point (S~GEN~; LRP), 80%S~MSY~, and U~MSY~ (medians +/- 95% credible intervals)."}
...
p <- ggplot() +
 ...
 # geom_vline(xintercept = 0.8, lty = 3) + #turn off WSP benchmark for simplicity
  geom_hline(yintercept = 1, lty = 2) +
  geom_path(data=kobe_df, aes(S_Smsy, U_Umsy), color = "grey") +
  geom_point(data=kobe_df, aes(S_Smsy, U_Umsy, text = year), color = "grey") +
