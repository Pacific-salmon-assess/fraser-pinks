...
```{r escape-harvest-plot, echo=FALSE, fig.align = "center", out.height='80%', out.width = '80%'}
...
```{r SR-plot, warning = FALSE, fig.align = "center", out.width = "80%"}
p <- ggplot() +
...
```{r kobe-plot, message = FALSE, warning = FALSE, fig.align = "center", out.height='80%', out.width = '80%'}
